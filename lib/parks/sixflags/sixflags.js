...
export class SixFlags extends Destination {
  ...
  async buildDestinationEntity() {
    ...
    for (const park of parks) {
      ...
      const entity = {
        ...
        _id: `sixflags_destination_${park.parkId}`,
  ...
  async buildParkEntities() {
    ...
    for (const park of parks) {
      ...
      const entity = {
        ...
        _destinationId: `sixflags_destination_${park.parkId}`,
        _parentId: `sixflags_destination_${park.parkId}`,
        name: park.name,
  ...
  async buildAttractionEntities() {
    ...
    for (const parkID of parkIDs) {
      ...
      const destinationEntity = destinations.find(d => d._id === `sixflags_destination_${parkID}`);
      ...
      attractionEntities.push(...rides.map(attraction => {
        const entity = {
          ...
          _parkId: `park_${parkID}`,
          _parentId: `park_${parkID}`,
          _destinationId: `sixflags_destination_${parkID}`,
