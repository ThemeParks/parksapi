      ...
      attraction.queues.forEach((queue) => {
        ...
        switch (queue.queue_type) {
          case 'STANDBY':
            ...
            if (queue.status != 'OPEN' && queue.status != 'OPENS_AT' && queue.status != 'CLOSED' && queue.status != 'CLOSES_AT' && queue.status != 'BRIEF_DELAY' && queue.status != 'N/A' && queue.status != 'RIDE_NOW' && queue.status != 'WEATHER_DELAY' && queue.status != 'VIRTUAL_LINE_ONLY' && queue.status != 'EXTENDED_CLOSURE' && queue.status != 'AT_CAPACITY') {
