...
export class AttractionsIO extends Destination {
  ...
  buildBaseEntityObject(data) {
    ...
    if (data?.MinimumHeightRequirement !== undefined) {
      entity._tags.push({
        id: 'minimumHeight',
        value: data.MinimumHeightRequirement * 100,
      });
    }
    ...
    if (data?.MinimumUnaccompaniedHeightRequirement !== null && data?.MinimumUnaccompaniedHeightRequirement !== undefined) {
      entity._tags.push({
        ...
        value: data.MinimumUnaccompaniedHeightRequirement * 100,
      });
    }
  ...
  async buildAttractionEntities() {
    return this._buildEntitiesFromCategories(['Attractions', 'Rides'], this.config.parkId, {
