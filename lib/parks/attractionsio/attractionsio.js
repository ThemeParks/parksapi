...
export class AttractionsIO extends Destination {
  ...
  async buildAttractionEntities() {
    return this._buildEntitiesFromCategories(['Attractions', 'Rides'], entityType.attraction, this.config.parkId);
  }
  ...
  async buildShowEntities() {
    return this._buildEntitiesFromCategories(['Shows', 'Show', 'Live Shows'], entityType.show, this.config.parkId);
  }
  ...
  async buildRestaurantEntities() {
    return this._buildEntitiesFromCategories(['Restaurants', 'Fast Food', 'Snacks', 'Healthy Food', 'Food', 'Dining', 'Food & Drink'], entityType.restaurant, this.config.parkId);
  }
